========================================================================
    ACTIVE TEMPLATE LIBRARY : SimpleExt Project Overview
========================================================================

AppWizard has created this SimpleExt project for you to use as the starting point for
...
SimpleExt.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (SimpleExt.h)
        GUID definitions                                (SimpleExt_i.c)
        A type library                                  (SimpleExt.tlb)
        Marshaling code                                 (SimpleExt_p.c and dlldata.c)

SimpleExt.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in SimpleExt.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named SimpleExt.pch and a precompiled types file named StdAfx.obj.
...
SimpleExtps.vcxproj
	...
	dlldata.c, SimpleExt_i.c and SimpleExt_p.c which are required
	to build the proxy/stub DLL.

SimpleExtps.vcxproj.filters
